...
void main() {
  group('ApiService Integration Tests', () {
    ...
    test('Fetch Prayer Times successfully', () async {
      ...
      debugPrint('✓ Prayer Times OK: Fajr is ${prayerTimes.fajr}');
    });
    ...
    test('Fetch Surah 114 (An-Nas) successfully', () async {
      ...
      debugPrint('✓ Quran API OK: Surah ${surah.name} has ${surah.ayahs.length} ayahs');
    });
    ...
    test('Fetch Hadiths from Abu Dawud successfully', () async {
      ...
      debugPrint('✓ Hadith API OK: Found ${hadithData.items.length} hadiths');
    });
    ...
    test('Fetch Radios successfully', () async {
      ...
      debugPrint('✓ Radio API OK: Found ${radioData.radios.length} radio stations');
    });
    ...
    test('Fetch Tafsir for Surah 114 successfully', () async {
      ...
      debugPrint('✓ Tafsir API OK: Found interpretation for Surah ${tafsirData.result.first.sura}');
    });
  });
}
